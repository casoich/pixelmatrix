        ...
        try {
            collection.find().toArray(function (err, items) {
                ...
                for (var i = 0; i < items.length; i++) {
                    ...
                    var scheduleTimestamp = moment(today + ' ' + items[i].time, 'MM/DD/YYYY H:mm:ss').add(4, 'h'); // convert to utc
                    ...
                    if (current.isAfter(scheduleTimestamp)) {
                        ...
                        if (!lastExecuted || scheduleTimestamp.isAfter(lastExecuted)) {
                            ...
                            console.log(timestamp + ' - starting feeder for ' + scheduleTimestamp.format('h:mm:ss a') + ' feeding, ' + units + ' units');
